                ...
                <div class="invoice padding-50 sm-padding-10">
                  <div>
                    ...
                    <div class="pull-right sm-m-t-20">
                      <h2 class="font-montserrat all-caps hint-text">Faktur Logistik In</h2>
                      <span class=" label label-success p-t-5 m-l-5 p-b-5 inline fs-12">New Product</span>
                    </div>
                  ...
                  <div class="col-12">
                    <div class="row">
                      <div class="col-lg-7 col-sm-height sm-no-padding">
                        ...
                        <?php $supplier = get_supplier($data_logisin->supplier) ?>
                        <h5 class="semi-bold m-t-0">[<?php echo $supplier->code ?>] <?php echo $supplier->name ?> </h5>
                        <address>
                                            <strong><?php echo $supplier->phone ?></strong>
                                            <br><?php echo $supplier->address ?>
                                        </address>
                      </div>
                    ...
                    <table class="table m-t-50">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center"><?php echo $inventory->harga_supplier ?></td>
                          <?php $sub_total = $inventory->qty_fisik * $inventory->harga_supplier; ?>
                          <?php $total += $sub_total; ?>
                          <td class="text-right"><?php echo $inventory->qty_fisik * $inventory->harga_supplier ?></td>
                        </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
                  ...
                  <div class="p-l-15 p-r-15">
                    <div class="row b-a b-grey">
                      ...
                      <div class="col-md-5 text-right bg-master-darker col-sm-height padding-15 d-flex flex-column justify-content-center align-items-end">
                        ...
                        <h1 class="no-margin text-white">Rp. <?php echo $total; ?></h1>
                      </div>
                    </div>
                  </div>
                  <hr>
