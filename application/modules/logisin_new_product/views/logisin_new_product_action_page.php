...
<!-- END JUMBOTRON -->
<form action="<?php echo base_url('logisin_new_product/process/'); ?>" id="form-customer" role="form" autocomplete="off" method="POST" novalidate>
      ...
      <div class="col-md-8">
        ...
        <div class="card card-transparent">
          <div class="btn-group sm-m-t-10">
            <a href="<?php echo base_url('product/action'); ?>" class="btn btn-primary">Input Barang</i>
            </a>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="text-right">
                          <a href="<?php echo base_url('product/destroy'); ?>" class="btn btn-danger">Ya</a>
            ...
            <table class="table table-hover" id="basicTable">
              ...
              <tbody>
                <?php foreach ($this->cart->contents() as $items): ?>
                  <tr>
                  <td>
                      <a href="<?php echo base_url('product/remove_shopping/' . $items['rowid']); ?>"><i class="fa fa-close"></i></a>
